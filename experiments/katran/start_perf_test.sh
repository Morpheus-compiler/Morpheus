...
DUT_PERF_SCRIPT_RESULT="${DUT_REMOTE_MORPHEUS_FOLDER}"/experiments/katran/perf_result
PKTGEN_TEST_SCRIPT_PATH="${DIR}"/start_throughput_test_pktgen.sh

PERF_RESULT_DUT_PATH="${DUT_REMOTE_MORPHEUS_FOLDER}"/experiments/katran/results/perf
...
Run Katran perf tests with different traffic localities using remote server
